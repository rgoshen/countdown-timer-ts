...
describe("Persistence", () => {
  ...
  it("stores the selected datetime and rehydrates on reload", async () => {
    ...
    expect(localStorage.getItem("countdown-target")).toBe("2030-01-01T12:10:00");
    ...
    const m2 = screen.getByLabelText(/minutes/i) as HTMLSelectElement;
        expect(date2.value).toBe("2030-01-01"); expect(h2.value).toBe("12"); expect(m2.value).toBe("10"); 
  });
